...
public class TileEntityRunebench extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Runebench";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			Runebench.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = RunebenchRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
	...
	public void smeltItem() {
		if (this.canSmelt()) {
			ItemStack itemstack = RunebenchRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
			System.out.println("stacksize "+furnaceItemStacks[0].stackSize);
	...
	public static int getItemBurnTime(ItemStack itemstack){
		if(itemstack == null){
			...
			if(item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air){
				...
				if(item == ModRegistry.crystalShard){
					return 200;
				}
