...
import de.rinonline.korinskills.skills.PlayerSpells;
...
public class ContainerRunebench extends Container {
	...
	private TileEntityRunebench tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;

	public ContainerRunebench(InventoryPlayer player, TileEntityRunebench tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				if(RunebenchRecipes.smelting().getSmeltingResult(itemstack1) != null){
					if(!this.mergeItemStack(itemstack1, 0, 1, false)){
						return null;
					}
				}else if(TileEntityRunebench.isItemFuel(itemstack1)){
